      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            Streamline Your
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600"> Training Management</span>
          </h1>

          {/* Subheading */}
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
            Schedule employee training, track progress with real-time analytics, and automate participant signatures—all in one powerful platform.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-10">
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm">
              ...
              <span className="text-gray-700 font-medium">Smart Scheduling</span>
            </div>
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm">
            ...
            <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg shadow-sm">
              ...
              <span className="text-gray-700 font-medium">Auto Signatures</span>
            </div>
          </div>
